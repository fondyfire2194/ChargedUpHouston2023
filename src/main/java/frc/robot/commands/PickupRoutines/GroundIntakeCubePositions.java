...
public class GroundIntakeCubePositions extends SequentialCommandGroup {
        /** Creates a new GroundIntake. */

        public GroundIntakeCubePositions(LiftArmSubsystem lift, WristSubsystem wrist, ExtendArmSubsystem extend,
                ...
                addCommands(
                                ...
                                new WaitLiftAtTarget(lift, 1, .25, 1).asProxy(),
                                ...
                                new WaitLiftAtTarget(lift, 1, .5, 2).asProxy());
