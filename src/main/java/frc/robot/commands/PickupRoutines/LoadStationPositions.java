...
public class LoadStationPositions extends SequentialCommandGroup {

        public LoadStationPositions(LiftArmSubsystem lift, WristSubsystem wrist, ExtendArmSubsystem extend,
                ...
                addCommands(
                                ...
                                new SetLiftGoal(lift, presetLiftAngles.PICKUP_LOAD_STATION
                                                .getInches()).asProxy(),
