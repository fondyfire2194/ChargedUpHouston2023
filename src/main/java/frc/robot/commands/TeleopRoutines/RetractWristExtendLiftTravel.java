...
public class RetractWristExtendLiftTravel extends SequentialCommandGroup {
        /** Creates a new ArmsHomeSequence. */
        public RetractWristExtendLiftTravel(LiftArmSubsystem lift, ExtendArmSubsystem ext, WristSubsystem wrist) {
