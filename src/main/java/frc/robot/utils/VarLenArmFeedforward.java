...
/** Add your docs here. */
public class VarLenArmFeedforward {
// Copyright (c) FIRST and other WPILib contributors.
// Open Source Software; you can modify and/or share it under the terms of
// the WPILib BSD license file in the root directory of this project.
 ...
 */
   ...
   */
  public VarLenArmFeedforward(double ks, double kg, double kv, double ka) {
    this.ks = ks;
    this.kg = kg;
    this.kv = kv;
    this.ka = ka;
   ...
   * @param kv The velocity gain.
   */
  public VarLenArmFeedforward(double ks, double kg, double kv) {
    this(ks, kg, kv, 0);
  }
